...
streetedges += "Id VARCHAR(100) NOT NULL PRIMARY KEY, "
...
streetedge_pavement += "IdStreetEdge VARCHAR(100) not null, "
...
streetedge_rails += "IdStreetEdge VARCHAR(100) not null, "
...
streetedge_safety += "IdStreetEdge VARCHAR(100) not null, "
...
streetedge_consolidatedelevation += "Id VARCHAR(100) NOT NULL PRIMARY KEY, "
...
streetedge_consolidatedsafety += "Id VARCHAR(100) NOT NULL PRIMARY KEY, "
...
trips_streetedges += "IdStreetEdge VARCHAR(100) not null, "
